...
public class FileFolder extends File {
	 ...
	 * @param child the name of this folder
	 */
	...
	/**
	 * @param pathname the full pathname, in the form drive/folder1/folder2/folder3/etc/thisFolder
	 */
	...
	/**
	 * @param uri a uri representing this folder's path
	 */
	...
	/**
	 * @param original A file to convert into a filefolder
	 */
	...
	public boolean hasParent = new File(getAbsolutePath().substring(0, getAbsolutePath().lastIndexOf("\\"))).exists();

	private void refreshValues() {
		isCorrect = isDirectory() && exists();
		hasParent = new File(getAbsolutePath().substring(0, getAbsolutePath().lastIndexOf("/"))).exists();
	}
